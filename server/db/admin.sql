...
-- ----------------------------
BEGIN;
INSERT INTO `t_menu` (`id`, `created_at`, `updated_at`, `deleted_at`, `parent_id`, `name`, `type`, `path`, `component`, `perm`, `sort`, `visible`, `icon`, `redirect`, `always_show`, `keep_alive`, `params`) VALUES (1, '2024-11-09 23:56:51', '2024-11-09 23:56:51', NULL, 0, '系统管理', 'CATALOG', '/system', 'Layout', '', 1, 1, 'system', '/system', 0, 1, NULL);
