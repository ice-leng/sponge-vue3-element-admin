...
type PlatformObjDetail struct {
	...
	CreatedAt common.LocalDateTime `json:"createdAt"` // 创建时间
	UpdatedAt common.LocalDateTime `json:"updatedAt"` // 更新时间
	...
	LastTime  common.LocalDateTime `json:"lastTime"`  // 上次登录时间
