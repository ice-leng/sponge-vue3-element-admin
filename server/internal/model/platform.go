...
type Platform struct {
	...
	RoleID         datatypes.JSON `gorm:"column:role_id;type:json;NOT NULL" json:"roleID"`                                                                                                    // 角色
	...
	ClaimTimeLimit int            `gorm:"column:claim_time_limit;type:int(11);NOT NULL" json:"claimTimeLimit"`                                                                                // 领取时间限制（小时）
}
